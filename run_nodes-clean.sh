...
# ==============================================================================
# RUN SCRIPT cho Narwhal-Bullshark (với xóa dữ liệu database)
# ==============================================================================
...
# Xóa tất cả các thư mục database (benchmark/.db-*)
echo "🗑️  Đang xóa dữ liệu database..."
rm -rf "$BENCHMARK_DIR"/.db-*
echo "✅ Đã xóa tất cả database (.db-*)"
